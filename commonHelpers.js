...
`)}function f(e){return`<li class="gallery-item">
        ...
        </li>`}function d(e){e.classList.remove("loader-hidden")}function g(e){e.classList.add("loader-hidden")}function y(e){const s="https://pixabay.com",o="/api/",a=new URLSearchParams({key:"44349742-ecc8a7b60aea5585f0c207813",q:e,image_type:"photo",orientation:"horizontal",safesearch:!0}),t=`${s}${o}?${a}`;return fetch(t).then(r=>r.json())}const h="/goit-js-hw-11/assets/icon-close-5bc7b79a.svg",n=document.querySelector(".search-form"),c=document.querySelector(".gallery");c.innerHTML="";const l=document.querySelector(".loader"),_=new p(".gallery a");n.addEventListener("submit",e=>{e.preventDefault();const s=e.target.elements.query.value.trim();s.length!==0&&(d(l),y(s).then(o=>{if(o.hits.length===0)m.show({class:"izt-toast-message",message:"Sorry, there are no images matching your search query. Please try again!",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:h,position:"topRight",theme:"dark"});else{const a=u(o.hits);c.innerHTML=a,_.refresh()}}).catch(o=>{console.log(o)}).finally(()=>{g(l)})),n.reset()});
