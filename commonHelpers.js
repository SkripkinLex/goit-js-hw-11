...
`)}function u(e){return`<li class="gallery-item">
        ...
        </li>`}function f(e){e.classList.remove("loader-hidden")}function d(e){e.classList.add("loader-hidden")}function g(e){const r="https://pixabay.com",o="/api/",a=new URLSearchParams({key:"44349742-ecc8a7b60aea5585f0c207813",q:e,image_type:"photo",orientation:"horizontal",safesearch:!0}),t=`${r}${o}?${a}`;return fetch(t).then(s=>s.json()).catch(s=>console.log(s))}const y="/goit-js-hw-11/assets/icon-close-5bc7b79a.svg",l=document.querySelector(".search-form"),h=document.querySelector(".gallery"),n=document.querySelector(".loader"),_=new c(".gallery a");l.addEventListener("submit",e=>{e.preventDefault();const r=e.target.elements.query.value.trim();r.length!==0&&(f(n),g(r).then(o=>{if(o.hits.length===0)p.show({class:"izt-toast-message",message:"Sorry, there are no images matching your search query. Please try again!",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:y,position:"topRight",theme:"dark"});else{const a=m(o.hits);h.innerHTML=a,_.refresh()}}).catch(o=>{console.log(o)}).finally(()=>{d(n)})),l.reset()});
