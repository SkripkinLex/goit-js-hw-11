...
`)}function u(e){return`<li class="gallery-item">
        ...
        </li>`}function f(e){e.classList.remove("loader-hidden")}function g(e){e.classList.add("loader-hidden")}function y(e){const r="https://pixabay.com",o="/api/",a=new URLSearchParams({key:"44349742-ecc8a7b60aea5585f0c207813",q:e,image_type:"photo",orientation:"horizontal",safesearch:!0}),t=`${r}${o}?${a}`;return fetch(t).then(s=>s.json()).then(s=>{const i=[];s.hits===i&&iziToast.show({message:"Sorry, there are no images matching your search query. Please, try again!",messageColor:"#fafafb"})}).catch(s=>{console.log(s)})}const d="/goit-js-hw-11/assets/icon-close-5bc7b79a.svg",n=document.querySelector(".search-form"),h=document.querySelector(".gallery"),l=document.querySelector(".loader"),_=new c(".gallery a");n.addEventListener("submit",e=>{e.preventDefault();const r=e.target.elements.query.value.trim();r.length!==0&&(f(l),y(r).then(o=>{if(o.hits.length===0)p.show({class:"izt-toast-message",message:"Sorry, there are no images matching your search query. Please try again!",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:d,position:"topRight",theme:"dark"});else{const a=m(o.hits);h.innerHTML=a,_.refresh()}}).catch(o=>{console.log(o)}).finally(()=>{g(l)})),n.reset()});
